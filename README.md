...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/golangci-lint-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/golangci-lint-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add golangci-lint
# for installing globally
pixi global install golangci-lint
```
...
It is possible to list all of the versions of `golangci-lint` available on your platform:
...
```
pixi search golangci-lint --channel conda-forge
```
